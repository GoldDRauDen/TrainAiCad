# AI ENTRYPOINT — V4.8 approved calibration on V4.7 DXF-first

Current production release is **V4.8**, adding user-approved whole-hole-group cancellation and three PDF-grounded 520709-07 regressions to **V4.7 OUTPUT / unchanged V4.6 manufacturing baseline**. Direct DXF is the default. Optional AutoLISP exists ONLY when the user expressly requests it. The existing lispcad module paths remain stable for backwards-compatible imports.
